...
namespace Apex.AI.Editor.UndoRedo
{
    ...
    public sealed class RemoveActionOperation : AIUIOperation, IUndoRedo
    {
        private ActionView _target;

        public RemoveActionOperation(AIUI ui, ActionView target)
            : base(ui)
        {
            _target = target;
        }

        public bool ConnectedTo(TopLevelView view)
        {
