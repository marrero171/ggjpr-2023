...
namespace Apex.AI.Editor.UndoRedo
{
    ...
    public sealed class ReplaceSelectorOperation : AIUIOperation, IUndoRedo
    {
        private SelectorView _target;
        private Selector _oldValue;
        private Selector _newValue;

        public ReplaceSelectorOperation(AIUI ui, Selector oldValue, Selector newValue, SelectorView target)
            : base(ui)
        {
            _target = target;
            _oldValue = oldValue;
