...
namespace Apex.AI.Editor.UndoRedo
{
    ...
    public sealed class ReplaceQualifierOperation : AIUIOperation, IUndoRedo
    {
        private QualifierView _target;
        private IQualifier _oldValue;
        private IQualifier _newValue;

        public ReplaceQualifierOperation(AIUI ui, IQualifier oldValue, IQualifier newValue, QualifierView target)
            : base(ui)
        {
            _target = target;
            _oldValue = oldValue;
