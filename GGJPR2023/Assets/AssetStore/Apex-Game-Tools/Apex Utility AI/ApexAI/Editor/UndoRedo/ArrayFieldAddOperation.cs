...
namespace Apex.AI.Editor.UndoRedo
{
    ...
    public sealed class ArrayFieldAddOperation : IUndoRedo, IViewBoundOperation, IMergableOperation
    {
        ...
        public ArrayFieldAddOperation(Array arr, Action<IList> setter, object value)
        {
            _arr = arr;
            _setter = setter;
            _value = value;
