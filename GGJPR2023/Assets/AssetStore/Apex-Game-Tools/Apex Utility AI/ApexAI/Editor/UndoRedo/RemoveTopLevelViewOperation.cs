...
namespace Apex.AI.Editor.UndoRedo
{
    ...
    public abstract class RemoveTopLevelViewOperation : AIUIOperation, IUndoRedo, IMergableOperation
    {
        private List<IUndoRedo> _relatedRemovals;
        private List<IUndoRedo> _relatedActionRemovals;

        public RemoveTopLevelViewOperation(AIUI ui)
            : base(ui)
        {
        }
        ...
        public void LogReferencingActionRemoval(ActionView av)
        {
