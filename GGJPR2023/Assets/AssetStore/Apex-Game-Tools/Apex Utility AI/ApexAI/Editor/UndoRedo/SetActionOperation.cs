...
{
    public sealed class SetActionOperation : AIUIOperation, IUndoRedo
    {
        private ActionView _oldAction;
        private ActionView _newAction;

        public SetActionOperation(AIUI ui, ActionView newAction)
            : base(ui)
        {
            _newAction = newAction;
        }

        public SetActionOperation(AIUI ui, ActionView oldAction, ActionView newAction)
            : base(ui)
        {
