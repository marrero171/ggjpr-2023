...
namespace Apex.AI.Editor.UndoRedo
{
    ...
    public sealed class ArrayFieldRemoveOperation : IUndoRedo, IViewBoundOperation
    {
        private Array _arr;
        private int _index;
        ...
        public ArrayFieldRemoveOperation(Array arr, Action<IList> setter, int index, object value)
        {
            _arr = arr;
            _index = index;
            _value = value;
