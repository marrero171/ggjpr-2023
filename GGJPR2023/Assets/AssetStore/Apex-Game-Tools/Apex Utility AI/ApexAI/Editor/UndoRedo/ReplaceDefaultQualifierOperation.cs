...
namespace Apex.AI.Editor.UndoRedo
{
    ...
    public sealed class ReplaceDefaultQualifierOperation : AIUIOperation, IUndoRedo
    {
        private SelectorView _target;
        private QualifierView _oldValue;
        private QualifierView _newValue;

        public ReplaceDefaultQualifierOperation(AIUI ui, QualifierView oldValue, QualifierView newValue, SelectorView target)
            : base(ui)
        {
            _target = target;
            _oldValue = oldValue;
